...
function ParticipantListItem({ participantId, raisedHand }: { participantId: string; raisedHand: boolean }) {
...
export function ParticipantPanel({ panelHeight }: { panelHeight: number }) {
  ...
  const filterParticipants = (sortedRaisedHandsParticipants: any[], participants: Map<string, any>) =>
