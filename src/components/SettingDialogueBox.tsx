...
const AudioAnalyser = ({ audioTrack }: { audioTrack: MediaStreamTrack | null }) => {
...
interface SettingDialogueBoxProps {
  open: boolean;
  onClose: () => void;
  popupVideoPlayerRef: React.RefObject<HTMLVideoElement>;
...
export default function SettingDialogueBox({
  ...
  videoTrack,
  audioTrack,
}: SettingDialogueBoxProps) {
  const [selectedMicLabel, setSelectedMicLabel] = useState<string | null>(null);
  const [selectedWebcamLabel, setSelectedWebcamLabel] = useState<string | null>(null);
  ...
  const handleSetting = (event: any, n: string) => {
    setSetting(n);
  };
                                                ...
                                                >
                                                  <div>
                                                    <div className="flex flex-col">
                                                      {mics.map(
                                                        (item: MediaDeviceInfo, index: number) => {
                                                          return (
                                                            item?.kind ===
                                                            "audioinput" && (
                                                              <div
